#
# $Id: html.tcl,v 1.7 2008-02-22 21:31:42 pda Exp $
#
# Modèle "texte"
#
# Historique
...
#   2007/03/14 : pda/moindrot : création du modèle news
#   2007/03/21 : pda/moindrot : génération fichier intermédiaire dans les news
#   2007/04/05 : pda/moindrot : vérification de l'unicité du couple date/auteur
#                               pour la génération de la balise guid du RSS
#   2008/02/22 : pda/moindrot : intégration dans le modèle texte standard
#
...
# une actu : son contenu est ajouté à un fichier dans /tmp, qui sera
# récupéré, trié, dédoublonné après la compilation du serveur Web.
