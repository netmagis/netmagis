#
# $Id: base.tcl 401 2010-10-08 13:03:58Z pda $
#
...
proc htg_elementbandeau {} {
	...
	set id $partie(soustitre)
        ...
        set aa [helem A $titre CLASS "niv_1" ONMOUSEOVER "close_all_menu();" ONFOCUS "blurLink(this);"]
        set ul [helem UL $refs CLASS "sous_menu_block"]
	set titre [helem LI $aa$ul  CLASS "menu first_item selected" ONMOUSEOVER "close_all_menu();"]
	append sousmenu $id
    }

    set dd [helem UL $refs CLASS "sous_menu_block"]
