...
%
% $Id: install.tex,v 1.16 2008-04-12 20:20:53 pda Exp $
%
% Historique
...
%    \usepackage [a4,palatino] {my2e}	% style "à moi-même personnellement je"
    ...
    % Cette commande est normalement dans my2e.sty, mais
    % il faut que latex2html puisse la "voir"
...
%    \end {quote}
    ...
    \begin {center}
	Version 1.4, avril 2008 \\
	\verb|$Id: install.tex,v 1.16 2008-04-12 20:20:53 pda Exp $| \\
	\copyright
