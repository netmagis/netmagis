...
%
% $Id: install.tex,v 1.10 2008-03-20 16:37:55 pda Exp $
%
% Historique
...
%    \end {quote}
    ...
    \begin {center}
	Version 1.4, ???? 2008 \\
	\verb|$Id: install.tex,v 1.10 2008-03-20 16:37:55 pda Exp $| \\
	\copyright
...
de l'application. Vous êtes donc libre de les installer où vous le
...
d'extension «~\texttt {.tcl}~» ainsi que le fichier \texttt {Makefile}.

Vous pouvez également copier les pages de manuel (fichiers d'extension
«~\texttt {.n}~»), mais ce n'est pas nécessaire.
...
\titreC {Modifications du paquetage webapp}
...
\titreC {Modifications du paquetage arrgen}

Aucune modification n'est nécessaire.

\titreC {Modifications du paquetage pgsql}

Aucune modification n'est nécessaire.

\titreC {Modifications du paquetage auth}
...
LDAP d'établissement, par exemple). Ce chapitre explique comment
installer un système d'authentification reposant sur une base
PostgreSQL.
...
\begin {itemize}
	...
	«~\verb|.htgt|~» du répertoire \verb|./pgauth/www/lib/| en
	...
	installez-les dans le répertoire \verb|./pgauth/www/lib/|. Vous
...
première partie du fichier \verb|./pgauth/inst/httpd.conf|) dans le fichier
