...
%
% $Id: install.tex,v 1.14 2008-04-11 10:31:51 pda Exp $
%
% Historique
...
%    \end {quote}
    ...
    \begin {center}
	Version 1.4, ???? 2008 \\
	\verb|$Id: install.tex,v 1.14 2008-04-11 10:31:51 pda Exp $| \\
	\copyright
...
une version supérieure ou égale à 8.0\footnote {La gestion des
...
IPv6 à partir de PostgreSQL version 8.0.}.
...
\begin {itemize}
	...
	inutile pour la plupart des organismes ayant adopté WebDNS,
	voire même un frein dans la mesure où cela nécessitait une
	double saisie des utilisateurs (une fois avec LDAP et une
	fois avec WebAuth)~;
...
de ses utilisateurs. Pour les organisations qui n'ont pas mis en
place un annuaire LDAP, WebAuth est dorénavant fourni avec WebDNS,
et continue de fournir un mode d'authentification basé sur une base
PostgreSQL.
