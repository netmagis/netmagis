...
#   legendes	    => (optionnel) Légendes qui accompagne chaque ligne. A envoyer 
...
our %global_conf = read_global_conf_file("%CONF%");

# load graph library
require "$global_conf{metrolibdir}/libgraph.pl";
