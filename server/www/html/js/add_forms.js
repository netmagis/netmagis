...
/***/ function(module, exports, __webpack_require__) {
	...
	var _inputs = __webpack_require__(168);

	var _forms_utils = __webpack_require__(203);

	var F = _interopRequireWildcard(_forms_utils);
	...
	var Select_block = _react2.default.createClass({
		...
		handleSearch: function handleSearch(event) {
			...
			(0, _inputs.getJSON)(query, function (res) {
		...
		search_form: function search_form() {
			return _react2.default.createElement(
				F.Row,
				null,
				_react2.default.createElement(F.Adropdown, { label: 'Network', name: 'cidr', dims: '2+1' }),
	...
	var Add_block = exports.Add_block = _react2.default.createClass({
		...
		addNext: function addNext(oldValues) {
			...
			oldValues["addr"] = IPv4_intA_to_dotquadA(IPv4_dotquadA_to_intA(oldValues["addr"]) + 1);
		...
		render: function render() {
			...
			switch (this.state.contents) {
				...
				case 1:
					return _react2.default.createElement(Add_host, { id: 'Addblk_addh', defValues: this.state.defaultAddHost, submtCallback: this.addNext });
	...
	_reactDom2.default.render(_react2.default.createElement(Add_block, null), document.getElementById('app'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.AJXdropdown = exports.AutoInput = exports.getJSON = undefined;
	...
	var _reactAutosuggest = __webpack_require__(169);
	...
	var AJXdropdown = exports.AJXdropdown = _react2.default.createClass({
		...
		render: function render() {
			...
			return _react2.default.createElement(
				_forms_utils.Dropdown_internal,
				this.props,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reducerAndActions = __webpack_require__(184);

	var _reducerAndActions2 = _interopRequireDefault(_reducerAndActions);

	var _Autosuggest = __webpack_require__(185);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _symbolObservable = __webpack_require__(177);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getPrototype = __webpack_require__(174),
	    isHostObject = __webpack_require__(175),
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(178)(global || window || this);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactAutowhatever = __webpack_require__(199);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getPrototype = __webpack_require__(194),
	    isHostObject = __webpack_require__(195),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _sectionIterator = __webpack_require__(200);

	var _sectionIterator2 = _interopRequireDefault(_sectionIterator);

	var _reactThemeable = __webpack_require__(201);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.Form = exports.Row = exports.Space = exports.Checkbox = exports.InputAdrop = exports.Inputdrop = exports.Adropdown = exports.Dropdown = exports.Dropdown_internal = exports.Button = exports.Ainput = exports.Input = undefined;
	...
	var _lang = __webpack_require__(204);
		...
		render: function render() {
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					'div',
					{ className: "col-md-" + grid_vals[1] },
					_react2.default.createElement(_inputs.AutoInput, _extends({}, this.props, { className: 'form-control' }))
				)
			);
		}
	...
	var Dropdown_internal = exports.Dropdown_internal = _react2.default.createClass({
		...
		getInitialState: function getInitialState() {
			...
			if (this.props.defaultValue) value = this.props.defaultValue;else if (this.props.children.length > 0) value = this.props.children[0].props.children;else value = undefined;

			return { value: value };
		},

		componentWillUpdate: function componentWillUpdate(newprops) {
			if (!this.state.value && newprops.children.length > 0) this.setState({ value: newprops.children[0].props.children });
		},
		...
		render: function render() {
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					'div',
					{ className: "dropdown col-md-" + grid_vals[1] },
					_react2.default.createElement(_inputs.AJXdropdown, this.props)
				)
			);
		}
	});
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					{ className: "input-group col-md-" + grid_vals[1],
						style: { "paddingLeft": "15px", "float": "left" } },
					_react2.default.createElement('input', _extends({ className: 'form-control' }, props)),
					_react2.default.createElement(_inputs.AJXdropdown, { name: this.props.ddname, defaultValue: this.props.ddDef,
						superClass: 'input-group-btn' })
				)
			);
		}
	...
	var Checkbox = exports.Checkbox = _react2.default.createClass({
		...
		render: function render() {
			...
			var label = (0, _lang.translate)(this.props.label);
