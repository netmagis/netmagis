...
#	- base : paramètres d'accès à la base d'authentification
#	- groupe : groupe nécessaire (ou vide si pas de groupe exigé)
...
#   2007/11/29 : pda/jean : ajout du paramètre groupe
#
